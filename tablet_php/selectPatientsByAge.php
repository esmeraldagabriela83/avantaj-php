...
<html lang="en">
  <head>
    ...
    <title>selectPatientsByAge.php</title>
...
<div class="container">
    <form id="formShowSelectAge" class="form" action="selectPatientsByAge.php" method="POST">

    <label for="writeAge">Write age</label><br>
                <input type="number" name="selectAge"  class="form-control"  id="writeAge" value="<?php
    ...
    <input class="btn btn-success" 
           type="submit"
           name="showPatientWithSelectedAge"
           value="Show patients with your written age" 
...
if(isset($_POST['showPatientWithSelectedAge'])){


    echo '<h3>You set age</h3>' ;

    echo '<h3>Your written age is : ' . $_POST['selectAge'] . '</h3>';
    ...
    $selectAge=$_POST['selectAge'];
        ...
        $selectie_db = mysqli_query($c_db, "SELECT * FROM patienttable WHERE age = $selectAge");
