<?php
    $c = mysqli_connect('localhost', 'root', '', 'cofetarieEx');
    ...
    mysqli_query($c, "INSERT INTO produseEx (nume_produs, pret, id_categorie, data_expirare) VALUES ('ecler', '13', '1','2022-12-31' )");
