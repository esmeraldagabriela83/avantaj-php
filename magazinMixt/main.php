...
<h1  id="uppageMain">Main</h1>
<h3>Administreaza</h3>


<section class="center_content" style="background-color:BurlyWood">

<!-- add products form -->

    <form id="formMain" class="form" action="main.php" method="POST" enctype="multipart/form-data">
...
if (isset($_POST['magazin_comment'])){echo $_POST['magazin_comment'];}
 ?>
        ...
        Add your image or file
            ...
            <input type="submit" name="adauga2" value="Aduaga produs" />
...
<section class="center_content" style="background-color:DarkSalmon">
...
if (isset($_POST['magazin_comment2'])){echo $_POST['magazin_comment2'];}
 ?>
        ...
        Add ANOTHER image or file
            ...
            <input type="submit" name="modifica2" value="Modifica"  />
        </form>
...
<a href="#uppageMain" style=" position: fixed; background-color:yellow;font-size:1rem;
                          bottom: 0;
                          right: 0;
